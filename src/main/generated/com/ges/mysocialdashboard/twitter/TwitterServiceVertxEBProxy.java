...
public class TwitterServiceVertxEBProxy implements TwitterService {
  ...
  public TwitterServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public TwitterServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
