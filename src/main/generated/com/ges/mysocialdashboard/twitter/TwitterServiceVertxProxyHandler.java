...
public class TwitterServiceVertxProxyHandler extends ProxyHandler {
  ...
  public TwitterServiceVertxProxyHandler(Vertx vertx, TwitterService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public TwitterServiceVertxProxyHandler(Vertx vertx, TwitterService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public TwitterServiceVertxProxyHandler(Vertx vertx, TwitterService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
